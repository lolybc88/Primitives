...
public class LanguageStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new example.LanguageRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.Language.example")) {
		EPackage.Registry.INSTANCE.put("http://www.Language.example", example.language.LanguagePackage.eINSTANCE);
	}
