...
public class LanguageActivator extends AbstractUIPlugin {
	...
	public static final String EXAMPLE_LANGUAGE = "example.Language";
	...
	protected Module getRuntimeModule(String grammar) {
		if (EXAMPLE_LANGUAGE.equals(grammar)) {
			return new example.LanguageRuntimeModule();
		}
	...
	protected Module getUiModule(String grammar) {
		if (EXAMPLE_LANGUAGE.equals(grammar)) {
			return new example.ui.LanguageUiModule(this);
		}
